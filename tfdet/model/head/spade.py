...
from tfdet.core.ops import feature_extract, euclidean, euclidean_matrix
...
def spade_head(feature, feature_vector = None, image_shape = [224, 224], k = 50, sampling_index = None, sigma = 4, method = "bilinear"):
