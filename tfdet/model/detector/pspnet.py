...
def pspnet(feature, n_class = 35, n_feature = 512, pool_scale = [1, 2, 3, 6], max_pooling = False, method = "bilinear", dropout_rate = 0.1,
           neck = None,
    ...
    out = pspnet_head(feature, n_class = n_class, n_feature = n_feature, pool_scale = pool_scale, max_pooling = max_pooling, method = method, dropout_rate = dropout_rate,
