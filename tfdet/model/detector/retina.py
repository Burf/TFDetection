...
def retinanet(feature, n_class = 21, image_shape = [1024, 1024], n_feature = 256, n_depth = 4,
    ...
    logits, regress, anchors = retina_head(feature, n_class = n_class, image_shape = image_shape, n_feature = n_feature, n_depth = n_depth, scale = scale, ratio = ratio, octave = octave,
