...
def mobilenet(x, weights = "imagenet", indices = None):
    model = tf.keras.applications.MobileNet(input_tensor = x, include_top = False, include_preprocessing = False, weights = weights)
...
def mobilenet_v2(x, weights = "imagenet", indices = None):
    model = tf.keras.applications.MobileNetV2(input_tensor = x, include_top = False, include_preprocessing = False, weights = weights)
